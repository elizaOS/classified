...
describe('/api/characters', () => {
  ...
  describe('GET /api/characters', () => {
    it('should return characters and stats for authenticated user', async () => {
      ...
      mock
        .mocked(characterService.getCharacters)
        .mockResolvedValue(mockCharacters as any);
      mock
        .mocked(characterService.getCharacterStats)
    ...
    it('should handle query parameters', async () => {
      mock.mocked(authService.getCurrentUser).mockResolvedValue(mockUser);
      mock.mocked(characterService.getCharacters).mockResolvedValue([]);
      mock.mocked(characterService.getCharacterStats).mockResolvedValue({
        totalCharacters: 0,
        activeCharacters: 0,
        totalConversations: 0,
        totalMessages: 0,
  ...
  describe('POST /api/characters', () => {
    ...
    it('should create character successfully', async () => {
      ...
      mock
        .mocked(characterService.createCharacter)
        .mockResolvedValue(mockCreatedCharacter as any);
