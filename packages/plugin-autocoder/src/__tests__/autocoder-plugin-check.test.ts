...
describe('Autocoder Plugin Configuration', () => {
  ...
  it('should have proper provider configuration', () => {
    ...
    const currentProjectProvider = autocoderPlugin.providers.find(p => p.name === 'CURRENT_PROJECT_CONTEXT');
  ...
  it('should have code generation service configured', () => {
    const codeGenService = autocoderPlugin.services.find(s => s.serviceName === 'code-generation');
