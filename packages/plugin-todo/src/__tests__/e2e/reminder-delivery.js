...
export const ReminderDeliveryE2ETestSuite = {
    ...
    tests: [
        {
            ...
            fn: async (runtime) => {
                ...
                const messageDeliveryService = runtime.getService('MESSAGE_DELIVERY');
        ...
        },
        {
            ...
            fn: async (runtime) => {
                ...
                // Create test data
                const testUserId = 'daily-test-user';
                const testRoomId = 'daily-test-room';
                const testWorldId = 'daily-test-world';
                // Create daily tasks
                const dailyTaskIds = [];
        ...
        },
        {
            ...
            fn: async (runtime) => {
                ...
                const testRoomId = 'spam-test-room';
                const testWorldId = 'spam-test-world';
        ...
        },
        {
            ...
            fn: async (runtime) => {
                ...
                const dataService = await import('../../services/todoDataService');
                const todoService = dataService.createTodoDataService(runtime);
                const testUserId = 'priority-test-user';
                const testRoomId = 'priority-test-room';
                const testWorldId = 'priority-test-world';
