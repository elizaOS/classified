...
export async function setupReminderDemo(runtime) {
    ...
    const typedReminderService = reminderService;
    if (typedReminderService) {
        await typedReminderService.checkTasksForReminders();
 ...
 */
export async function monitorReminders(runtime, duration = 60000) {
 ...
 * Clean up demo tasks
 */
export async function cleanupDemo(runtime, testUserId) {
