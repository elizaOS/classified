import { composePrompt, logger, ModelType, parseKeyValueXml, formatMessages, } from '@elizaos/core';
 ...
 */
async function extractConfirmationIntent(runtime, message, pendingTask, state) {
    try {
        if (!pendingTask) {
 ...
 */
export const confirmTodoAction = {
    name: 'CONFIRM_TODO',
    ...
    validate: async (runtime, message, state) => {
        ...
        const pendingTodo = state?.data?.pendingTodo;
        return !!pendingTodo;
    },
