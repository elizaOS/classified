use crate::backend::{BackendError, BackendResult, BackendConfig};
...
impl HttpServer {
    ...
    pub fn new() -> Self {
        Self {
            ...
            container_manager: Arc::new(ContainerManager::new(crate::backend::ContainerRuntimeType::Podman).expect("Failed to create container manager")),
